...
syntax keyword plantumlTypeKeyword namespace component package interface class interface enum object participant activity skinparam sequence
syntax keyword plantumlKeyword actor partition title activate as deactivate note left right top bottom of end
syntax keyword plantumlKeyword if then else endif alt
...
" Labels with a colon
syntax match plantumlColonLine /:[^:].*/ contains=plantumlString
